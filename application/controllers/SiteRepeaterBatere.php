...
class SiteRepeaterBatere extends needLogin {
	...
	public function index(){
		...
		if ($this->input->get('search') == true){
			...
			$model = $this->SiteRepeaterBatereModel->search($searchParams);
		}else{

			$model = $this->SiteRepeaterBatereModel->all();
		}
	...
	public function add(){
		...
		if ($this->input->post('simpan') == 'simpan'){
			...
			//JIKA SUBMIT DATA
			if ($this->SiteRepeaterBatereModel->save($data)){
	...
	public function edit($id){
		...
		$model=$this->SiteRepeaterBatereModel->get($id);
		$alert = '';
		...
		if ($this->input->post('simpan') == 'simpan'){
			...
			if ($this->SiteRepeaterBatereModel->update($model)){
	...
	public function view($id){
		$data['model']=$this->SiteRepeaterBatereModel->get($id);
		$data['another'] = 'ifi';
	...
	public function delete($id){
		if ($this->SiteRepeaterBatereModel->delete($id)) {
			redirect($this->router->fetch_class().'/index'); 
		}else{
