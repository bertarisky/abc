...
class Vpn extends needLogin {
	...
	public function index(){
		...
		if ($this->input->get('search') == true){
			...
			$model = $this->VpnModel->search($searchParams);
		}else{

			$model = $this->VpnModel->all();
		}
