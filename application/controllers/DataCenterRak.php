...
class DataCenterRak extends needLogin {
	...
	public function index(){
		...
		if ($this->input->get('search') == true){
			...
			$model = $this->DataCenterRakModel->search($searchParams);
		}else{

			$model = $this->DataCenterRakModel->all();
		}
	...
	public function pdf(){
	    ...
	    $pdf->WriteHTML($html);
	    $pdf->Output('Data_Center_Rak.pdf', 'D');
	...
	public function add(){
		...
		if ($this->input->post('simpan') == 'simpan'){
			...
			//JIKA SUBMIT DATA
			if ($this->DataCenterRakModel->save($data)){
	...
	public function edit($id){
		...
		$model=$this->DataCenterRakModel->get($id);
		$alert = '';
		...
		if ($this->input->post('simpan') == 'simpan'){
			...
			if ($this->DataCenterRakModel->update($model)){
	...
	public function view($id){
		$data['model']=$this->DataCenterRakModel->get($id);
		$data['another'] = 'ifi';
	...
	public function delete($id){
		if ($this->DataCenterRakModel->delete($id)) {
			redirect($this->router->fetch_class().'/index'); 
		}else{
