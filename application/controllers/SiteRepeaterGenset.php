...
class SiteRepeaterGenset extends needLogin {
	...
	public function index(){
		...
		if ($this->input->get('search') == true){
			...
			$model = $this->SiteRepeaterGensetModel->search($searchParams);
		}else{

			$model = $this->SiteRepeaterGensetModel->all();
		}
	...
	public function add(){
		...
		if ($this->input->post('simpan') == 'simpan'){
			...
			//JIKA SUBMIT DATA
			if ($this->SiteRepeaterGensetModel->save($data)){
	...
	public function edit($id){
		...
		$model=$this->SiteRepeaterGensetModel->get($id);
		$alert = '';
		...
		if ($this->input->post('simpan') == 'simpan'){
			...
			if ($this->SiteRepeaterGensetModel->update($model)){
	...
	public function view($id){
		$data['model']=$this->SiteRepeaterGensetModel->get($id);
		$data['another'] = 'ifi';
	...
	public function delete($id){
		if ($this->SiteRepeaterGensetModel->delete($id)) {
			redirect($this->router->fetch_class().'/index'); 
		}else{
