...
class DataCenterCctv extends needLogin {
	...
	public function index(){
		...
		if ($this->input->get('search') == true){
			...
			$model = $this->DataCenterCctvModel->search($searchParams);
		}else{

			$model = $this->DataCenterCctvModel->all();
		}
	...
	public function pdf(){
	    ...
	    $pdf->WriteHTML($html);
	    $pdf->Output('Data_Center_CCTV.pdf', 'D');
	...
	public function add(){
		...
		if ($this->input->post('simpan') == 'simpan'){
			...
			//JIKA SUBMIT DATA
			if ($this->DataCenterCctvModel->save($data)){
	...
	public function edit($id){
		...
		$model=$this->DataCenterCctvModel->get($id);
		$alert = '';
		...
		if ($this->input->post('simpan') == 'simpan'){
			...
			if ($this->DataCenterCctvModel->update($model)){
	...
	public function view($id){
		$data['model']=$this->DataCenterCctvModel->get($id);
		$data['another'] = 'ifi';
	...
	public function delete($id){
		if ($this->DataCenterCctvModel->delete($id)) {
			redirect($this->router->fetch_class().'/index'); 
		}else{
