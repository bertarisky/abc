  ...
  <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table"></i> Data Table Repeater/Mobile/HT
      </div>

      <div class="card-body">
        <div class=""  style="overflow-x: scroll;">
          <p><a href="<?php echo site_url('gdg/add');?>" class="btn btn-info pull-left">
            ...
            <thead>
              ...
              <form id="search" method="get">
                ...
                <td>
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="text" name="type_gdg" class="form-control" placeholder="Jenis/Type" value="<?php echo @$model['type_gdg'];?>">
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="text" name="band" class="form-control" placeholder="Band" value="<?php echo @$model['band'];?>">
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="text" name="daya" class="form-control" placeholder="Daya" value="<?php echo @$model['daya'];?>">
                    </div>
                  </div>
                </td>
            ...
            <tbody>
              <?php $n=0;
                ...
                <tr class="active">
                  ...
                  <td><?php echo $u['type_gdg'];?></td>
                  <td><?php echo $u['no_seri'];?></td>
                  <td><?php echo $u['versi_firmware'];?></td>
                  <td><?php echo $u['band'];?></td>
                  <td><?php echo $u['daya'];?></td>
                  <td><?php echo $u['kontrak'];?></td>
                  <td><?php echo substr($u['keterangan'], 0,6);?></td>
                  <td>
                    <a href="<?php echo site_url('gdg/view/'.$u['id']);?>" class="btn btn-info"><i class="fas fa-eye"></i></a>

                    <a href="<?php echo site_url('gdg/edit/'.$u['id']);?>" class="btn btn-success"><i class="fas fa-edit"></i></a>

                    <a href="<?php echo site_url('gdg/delete/'.$u['id']);?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
              <?php } ?>
