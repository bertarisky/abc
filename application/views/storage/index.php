  ...
  <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table"></i> Data Table Sistem Informasi - Storage
      </div>

      <div class="card-body">
        <div class=""  style="overflow-x: scroll;">
          <p><a href="<?php echo site_url('storage/add');?>" class="btn btn-info pull-left">
          ...
          td, th{
            ...
            <thead>
              <tr class="info">
                ...
                <th rowspan="2" align="center">RPM</th>
                <th rowspan="2" align="center">Kapasitas</th>
                <th rowspan="2" align="center">Pemanfaatan</th>
              ...
              <form id="search" method="get">
                ...
                <td>
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="text" name="type_storage" class="form-control" placeholder="Jenis/Type" value="<?php echo @$model['type_server'];?>">
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="text" name="rpm" class="form-control" placeholder="RPM" value="<?php echo @$model['rpm'];?>">
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="text" name="kapasitas" class="form-control" placeholder="Kapasitas" value="<?php echo @$model['kapasitas'];?>">
                    </div>
                  </div>
                </td>
            ...
            <tbody>
              <?php $n=0;
                ...
                <tr class="active">
                  ...
                  <td><?php echo $u['type_storage'];?></td>
                  <td><?php echo $u['no_seri'];?></td>
                  <td><?php echo $u['rpm'];?></td>
                  ...
                  <td>
                    <a href="<?php echo site_url('storage/view/'.$u['id']);?>" class="btn btn-info"><i class="fas fa-eye"></i></a>

                    <a href="<?php echo site_url('storage/edit/'.$u['id']);?>" class="btn btn-success"><i class="fas fa-edit"></i></a>

                    <a href="<?php echo site_url('storage/delete/'.$u['id']);?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
              <?php } ?>
