  ...
  <div class="card mb-3">
    <div class="card-header">
      <i class="fas fa-table"></i> View Data Genset
    </div>
        ...
        <table class="table table-bordered">
          ...
          <tr>
            <th width="200px">Aksi
              ...
              <?php if(isLoggedIn()):?>
                <a href="<?php echo site_url('siterepeatergenset/edit/'.$model['id']);?>" class="btn btn-sm btn-success">
                <i class="fas fa-edit"></i></a>

                <a href="<?php echo site_url('siterepeatergenset/delete/'.$model['id']);?>" class="btn btn-sm btn-danger">
              ...
              <?php endif; ?>
  				...
  				<a href="<?php echo site_url('siterepeatergenset/index');?>" class="btn btn-sm btn-danger">
