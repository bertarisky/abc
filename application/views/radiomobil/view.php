  ...
  <div class="card mb-3">
    <div class="card-header">
      <i class="fas fa-table"></i> View Data Table Radio Mobil
    </div>
    ...
    <div class="card-body">
      <div class="col-md-12">          
        <table class="table table-hover table-bordered">
          ...
          <tr class="info">
            <th width="200px">No Pol Kendaraan
              <td colspan="2"><?php echo $model['no_pol'];?></td>
            </th>
          </tr>
          ...
          <tr>
            <th>Aksi
              <td colspan="2">
                <a href="<?php echo site_url('radiomobil/edit/'.$model['id']);?>" class="btn btn-success">
                <i class="fas fa-edit"></i></a>

                <a href="<?php echo site_url('radiomobil/delete/'.$model['id']);?>" class="btn btn-danger">
