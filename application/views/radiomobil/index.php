  ...
  <div class="card mb-3">
        <div class="card-header">
          <i class="fas fa-table"></i> Data Table Radio Mobil
        </div>

        <div class="card-body">
          <div class=""  style="overflow-x: scroll;">
            <p><a href="<?php echo site_url('radiomobil/add');?>" class="btn btn-info pull-left">
            ...
            <style type="text/css">
              ...
              <thead class="thead-light">
                <tr class="info">
                  ...
                  <th rowspan="3">No Pol Kendaraan</th>
                ...
                <form id="search" method="get">
                  ...
                  <td>
                    <div class="form-group">
                      <div class="col-md-12">
                        <input type="text" name="no_pol" class="form-control" placeholder="no pol" value="<?php echo @$model['no_pol'];?>">
                      </div>
                    </div>
                  </td>
              ...
              <tbody>
                <?php $n=0;
                  ...
                  <tr class="active">
                    ...
                    <td>
                      <a href="<?php echo site_url('radiomobil/view/'.$u['id']);?>" class="btn btn-info">
                      <i class="far fa-eye"></i></a>

                      <a href="<?php echo site_url('radiomobil/edit/'.$u['id']);?>" class="btn btn-success">
                      <i class="fas fa-edit"></i></a>

                      <a href="<?php echo site_url('radiomobil/delete/'.$u['id']);?>" class="btn btn-danger">
