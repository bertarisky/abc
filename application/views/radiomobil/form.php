	<div class="panel-body bgtable">
		<p class="alert-danger"><?php echo @$alert;?></p>
			...
			<form method="post" class="form-horizontal">
            	...
            	<div class="form-group">
					<div class="form-label-group">
						<input type="text" id="no_pol" name="no_pol" class="form-control" placeholder="no pol" value="<?php echo @$model['no_pol'];?>" required="required" autofocus="autofocus">
						<label for="no_pol">No Pol Kendaraan</label>
					</div>
            	</div>
