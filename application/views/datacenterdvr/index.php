  ...
  <div class="card mb-3">
        <div class="card-header">
          <i class="fas fa-table"></i> Data DVR
        </div>
        ...
        <div class="card-body">
          ...
          <p>
            <?php if(isLoggedIn()):?>
              <a href="<?php echo site_url('datacenterdvr/add');?>" class="btn btn-sm btn-info pull-left">
              <i class="fas fa-plus"></i> Tambah</a>
            <?php endif; ?>

              <a href="<?php echo site_url('datacenterdvr/pdf');?>" class="btn btn-sm btn-success pull-left">
              ...
              <tbody>
                ...
                <?php $n=0;
                  ...
                  <tr class="active">
                    ...
                    <td>
                      <a href="<?php echo site_url('datacenterdvr/view/'.$u['id']);?>" class="btn btn-sm btn-info">
                      <i class="far fa-eye"></i></a>

                      <?php if(isLoggedIn()):?>
                        <a href="<?php echo site_url('datacenterdvr/edit/'.$u['id']);?>" class="btn btn-sm btn-success">
                        <i class="fas fa-edit"></i></a>

                        <a href="<?php echo site_url('datacenterdvr/delete/'.$u['id']);?>" class="btn btn-sm btn-danger">
