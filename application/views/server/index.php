  ...
  <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table"></i> Data Table Sistem Informasi - Server
      </div>

      <div class="card-body">
        <div class=""  style="overflow-x: scroll;">
          <p><a href="<?php echo site_url('server/add');?>" class="btn btn-info pull-left">
          ...
          td, th{
            ...
            <thead>
              <tr class="info">
                ...
                <th rowspan="2" align="center">CPU</th>
                <th rowspan="2" align="center">Memory</th>
                <th rowspan="2" align="center">Internal Hardisk</th>
              ...
              <form id="search" method="get">
                ...
                <td>
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="text" name="type_server" class="form-control" placeholder="Jenis/Type" value="<?php echo @$model['type_server'];?>">
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="text" name="internal_hardisk" class="form-control" placeholder="Internal Hardisk" value="<?php echo @$model['internal_hardisk'];?>">
                    </div>
                  </div>
                </td>
            ...
            <tbody>
              <?php $n=0;
                ...
                <tr class="active">
                  ...
                  <td>
                    <a href="<?php echo site_url('server/view/'.$u['id']);?>" class="btn btn-info"><i class="fas fa-eye"></i></a>

                    <a href="<?php echo site_url('server/edit/'.$u['id']);?>" class="btn btn-success"><i class="fas fa-edit"></i></a>

                    <a href="<?php echo site_url('server/delete/'.$u['id']);?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
              <?php } ?>
