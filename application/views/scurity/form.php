	<div class="panel-body bgtable">
		...
		<form method="post" class="form-horizontal">
			...
			<div class="form-group">
				<div class="form-label-group">
					<input type="text" id="type_scurity" name="type_scurity" class="form-control" placeholder="Jenis/Type" value="<?php echo @$model['type_scurity'];?>" required="required" autofocus="autofocus">
					<label for="type_scurity">Jenis/Type</label>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="form-label-group">
					<input type="text" id="fungsi" name="fungsi" class="form-control" placeholder="Fungsi" value="<?php echo @$model['fungsi'];?>" required="required" autofocus="autofocus">
			...
			<div class="form-group">
				<input type="hidden" name="id">
					<div class="col-md-12">
						...
						<a href="<?php echo site_url('scurity/index')?>" class="btn btn-danger"><span class="glyphicon glyphicon-chevron-left"></span> kembali</a>
					</div>
				</input>
			</div>
		</form>
