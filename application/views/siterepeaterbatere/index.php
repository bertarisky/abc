  ...
  <div class="card mb-3">
        ...
        <div class="card-body">
          <div class=""  style="overflow-x: scroll;">
            ...
            <?php if(isLoggedIn()):?>
              <p><a href="<?php echo site_url('siterepeaterbatere/add');?>" class="btn btn-sm btn-info pull-left">
              ...
              <tbody>
                ...
                <?php $n=0;
                  ...
                  <tr class="active">
                    ...
                    <td>
                      <a href="<?php echo site_url('siterepeaterbatere/view/'.$u['id']);?>" class="btn btn-sm btn-info">
                      <i class="far fa-eye"></i></a>

                      <?php if(isLoggedIn()):?>
                        <a href="<?php echo site_url('siterepeaterbatere/edit/'.$u['id']);?>" class="btn btn-sm btn-success">
                        <i class="fas fa-edit"></i></a>

                        <a href="<?php echo site_url('siterepeaterbatere/delete/'.$u['id']);?>" class="btn btn-sm btn-danger">
