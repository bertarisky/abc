        ...
        <table class="table table-bordered">
          ...
          <tr>
            <th width="200px">Aksi
              ...
              <?php if(isLoggedIn()):?>
                <a href="<?php echo site_url('siterepeaterbatere/edit/'.$model['id']);?>" class="btn btn-sm btn-success">
                <i class="fas fa-edit"></i></a>

                <a href="<?php echo site_url('siterepeaterbatere/delete/'.$model['id']);?>" class="btn btn-sm btn-danger">
              ...
              <?php endif; ?>
  				...
  				<a href="<?php echo site_url('siterepeaterbatere/index');?>" class="btn btn-sm btn-danger">
