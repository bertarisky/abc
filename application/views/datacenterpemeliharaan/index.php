  ...
  <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <p>
            <?php if(isLoggedIn()):?>
              <a href="<?php echo site_url('datacenterpemeliharaan/add');?>" class="btn btn-sm btn-info pull-left">
              <i class="fas fa-plus"></i> Tambah</a>
            <?php endif; ?>

              <a href="<?php echo site_url('datacenterpemeliharaan/pdf');?>" class="btn btn-sm btn-success pull-left">
              ...
              <!-- <thead>
                ...
                <form id="search" method="get">
                  ...
                  <td>
                    <div class="form-group">
                      <div class="col-md-12">
                        <input type="text" name="personil_pelaksana" class="form-control form-control-sm" placeholder="nomor personil_pelaksana" value="<?php echo @$model['personil_pelaksana'];?>">
                      </div>
                    </div>
                  </td>
              ...
              <tbody>
                ...
                <?php $n=0;
                  ...
                  <tr class="active">
                    ...
                    <td>
                      <a href="<?php echo site_url('datacenterpemeliharaan/view/'.$u['id']);?>" class="btn btn-sm btn-info">
                      <i class="far fa-eye"></i></a>

                      <?php if(isLoggedIn()):?>
                        <a href="<?php echo site_url('datacenterpemeliharaan/edit/'.$u['id']);?>" class="btn btn-sm btn-success">
                        <i class="fas fa-edit"></i></a>

                        <a href="<?php echo site_url('datacenterpemeliharaan/delete/'.$u['id']);?>" class="btn btn-sm btn-danger">
