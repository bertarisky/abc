  ...
  <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table"></i> Data Table VPN-IP
      </div>

      <div class="card-body">
        <div class=""  style="overflow-x: scroll;">
          <p><a href="<?php echo site_url('vpn/add');?>" class="btn btn-info pull-left">
            ...
            <tbody>
              <?php $n=0;
                ...
                <tr class="active">
                  ...
                  <td>
                    <a href="<?php echo site_url('vpn/view/'.$u['id']);?>" class="btn btn-info"><i class="fas fa-eye"></i></a>

                    <a href="<?php echo site_url('vpn/edit/'.$u['id']);?>" class="btn btn-success"><i class="fas fa-edit"></i></a>

                    <a href="<?php echo site_url('vpn/delete/'.$u['id']);?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
              <?php } ?>
